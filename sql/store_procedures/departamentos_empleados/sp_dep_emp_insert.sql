...
BEGIN
    ...
    ELSEIF EXISTS (SELECT * FROM departamentos_empleados 
    ...
    ELSE
        ...
        INSERT INTO
            public.departamentos_empleados(departamento_id, empleado_id)
        VALUES
            (p_dep_id, p_emp_id)
        RETURNING 
            departamento_id, empleado_id INTO p_dep_id_new, p_emp_id_new;
