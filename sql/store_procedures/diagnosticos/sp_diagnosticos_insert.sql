...
BEGIN
    ...
    ELSE
        ...
        INSERT INTO 
            public.diagnosticos (paciente_id, fecha_ingreso, fecha_salida, resumen, razon_ingreso, fecha)
        VALUES 
            (p_paciente_id, TO_DATE(p_fecha_ingreso, 'YYYY-MM-DD'), TO_DATE(p_fecha_salida, 'YYYY-MM-DD'), p_resumen, p_razon_ingreso, TO_DATE(p_fecha, 'YYYY-MM-DD'))
        RETURNING
            diagnosticos.id INTO p_id_new;
