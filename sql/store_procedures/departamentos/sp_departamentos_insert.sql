...
BEGIN
    ...
    ELSEIF EXISTS (SELECT * FROM departamentos WHERE edificio = p_edificio 
    ...
    ELSE
        ...
        INSERT INTO
            public.departamentos(nombre, edificio, descripcion, hospital_id)
        VALUES
            (p_nombre, p_edificio, p_descripcion, p_hospital_id)
		RETURNING 
			departamentos.id INTO p_id_new;
